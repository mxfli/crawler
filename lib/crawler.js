...
var crawl = function (uriObj) {
  ...
  var pipeCrawl = function (uriObj) {
    needle.get(uriObj.uri, {compressed: true, follow: true, headers: requestOptions}, function (err, res, body) {
  ...
  if (uriObj.type !== "link") {
    ...
    needle.get(uri, needleOptions, function (err, res, body) {
      ...
      var saveCrawledUri = function (output) {
        //TODO change absolute url to relative path.
      ...
      var handler = {
        ...
        push: function (uriObj) {
          ...
          }else if(hostname !== crawlOptions.host){
            //TODO crawl htird part site resource to local.
            return;
          }
